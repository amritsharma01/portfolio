...
const About = () => {
  return (
    <section className="py-20 bg-gray-100 dark:bg-gray-800" id="about">
        ...
        >
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 md:p-12 shadow-lg">
            <div className="prose prose-lg dark:prose-invert max-w-none">
              <h3 className="text-2xl font-bold mb-4">Who is Amrit Sharma?</h3>
              ...
              <h3 className="text-2xl font-bold mt-8 mb-4">Education & Background</h3>
              <p className="text-foreground/90 mb-4">
              ...
              <h3 className="text-2xl font-bold mt-8 mb-4">Technical Expertise</h3>
              <p className="text-foreground/90 mb-4">
              ...
              <h3 className="text-2xl font-bold mt-8 mb-4">Location & Contact</h3>
